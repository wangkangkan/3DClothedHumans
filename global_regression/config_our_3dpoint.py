...
flags.DEFINE_string('load_path', './logs/HMR_3DSUP_tran_tfrecords_30w_resnet_fc3_dropout_Elr1e-05_kp-weight60_Dlr1e-04_3dsup-weight60_Sep23_1105', 'path to trained model')
...
flags.DEFINE_list('datasets', ['tran_tfrecords_30w'],
...
# Hyper parameters:
flags.DEFINE_float('e_lr', 1e-6, 'Encoder learning rate')
