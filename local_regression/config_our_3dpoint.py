...
PRETRAINED_MODEL = '../stage2_new/logs/HMR_3DSUP_tran_tfrecords_p2_2_resnet_fc3_dropout_Elr1e-05_kp-weight60_Dlr1e-04_3dsup-weight60_Oct02_0236/model.ckpt-832831'
...
flags.DEFINE_string('smpl_face_path', SMPL_FACE_PATH,
                    'path to smpl mesh faces (for easy rendering)')#'D:/
flags.DEFINE_string('load_path', './logs/HMR_3DSUP_tran_tfrecords_p2_2_resnet_fc3_dropout_Elr1e-05_kp-weight60_Dlr1e-04_3dsup-weight60_Oct02_0236', 'path to trained model')
flags.DEFINE_string('pretrained_model_path', None,#'D:/hmr-master/src/models/resnet_v2_50.ckpt'
...
DATA_DIR = '/test/ICPR_data/male/render'#''/scratch1/projects/tf_datasets/'
...
flags.DEFINE_list('datasets', ['tran_tfrecords_p2_2'],
...
flags.DEFINE_integer('pointNet_pointnum', 2500, 'point number of each example in PointNet')#
# 8192
flags.DEFINE_integer('initpara_tag', 1, 'point number of each example in PointNet')
