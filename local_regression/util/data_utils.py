...
def parse_example_proto_our_3dpoint_initpara(example_serialized, pointnum):
    """Parses an Example proto.
    It's contents are:
    ...
    feature_map = {
        ...
        'initpara/initparameter':
            tf.FixedLenFeature((157,), dtype=tf.float32),
    }
    ...
    initparameter = tf.cast(features['initpara/initparameter'], dtype=tf.float32)
